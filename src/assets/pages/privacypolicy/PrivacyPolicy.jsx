...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="privacy-page">
      <SEO title={translate("privacy_title") || "Política de Privacidad"} />
      <div className="privacy-container">
        ...
        <div className="privacy-content">
          ...
          <ul>
            <li>
              <strong>{translate("privacy_li_6_1").split(":")[0]}:</strong>{" "}
              {translate("privacy_li_6_1").split(":")[1]}
            </li>
            <li>
              <strong>{translate("privacy_li_6_2").split(":")[0]}:</strong>{" "}
              {translate("privacy_li_6_2").split(":")[1]}
            </li>
            <li>
              <strong>{translate("privacy_li_6_3").split(":")[0]}:</strong>{" "}
              {translate("privacy_li_6_3").split(":")[1]}
            </li>
            <li>
              <strong>{translate("privacy_li_6_4").split(":")[0]}:</strong>{" "}
              {translate("privacy_li_6_4").split(":")[1]}
            </li>
          </ul>
