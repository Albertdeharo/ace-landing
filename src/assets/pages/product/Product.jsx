...
import './Product.css';
import { FaShoppingCart, FaCheckCircle, FaShieldAlt, FaTruck, FaClock } from 'react-icons/fa';
      ...
      <section className="product-hero" ref={ref}>
        <div className="container product-container-new">
          ...
          <div className="product-header-section">
            <h1 className="product-main-title">{translate('product_title') || 'Elige tu formato ideal'}</h1>
            <p className="product-subtitle">
              {translate('product_subtitle') || 'El spray antideslizante definitivo para un control total.'}
            </p>
          </div>
          ...
          <div className="product-pricing-section">
            <div className="cards-grid">
              ...
              <div className="pricing-card coming-soon">
                <div className="badge badge-gray">{translate('product_badge_soon') || 'Próximamente'}</div>
                <div className="coming-soon-content">
                  <div className="coming-soon-info">
                    <h3 className="card-title">{translate('product_unit_travel') || 'Formato Viaje'}</h3>
                    <p className="card-volume">100 ml</p>
                  </div>
                  <button className="cta-stripe-button btn-disabled" disabled>
                    <FaClock className="button-icon" /> {translate('product_btn_soon') || 'Muy pronto'}
                  </button>
                </div>
              </div>

            </div>
            <p className="secure-checkout-text">{translate('product_secure_payment') || 'Pagos seguros 100% encriptados con Stripe'}</p>
          </div>
