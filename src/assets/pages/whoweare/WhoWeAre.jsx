      ...
      <section className="about-philosophy section">
        <div className="philosophy-grid">
          <div className="philosophy-card">
            ...
            <p className="custom-description p-0" dangerouslySetInnerHTML={{ __html: translate('philosophy_text_1') }}></p>
          </div>
          <div className="philosophy-card">
            <h2 className="accent-title">{translate('philosophy_title_2')}</h2>
            <p className="custom-description p-0" dangerouslySetInnerHTML={{ __html: translate('philosophy_text_2') }}></p>
          </div>
        </div>
      </section>
      ...
      <section className="about-commitment section">
        <div className="commitment-flex flex-center text-center">
          <div className="commitment-text">
            <h2 className="accent-title" style={{ border: 'none', padding: 0 }}>{translate('about_com_title')}</h2>
            <p className="custom-description p-0">{translate('about_com_text')}</p>
